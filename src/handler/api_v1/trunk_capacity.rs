...
async fn get_capacity(
    ...
    // live tracking deferred — trunk_capacity_state not yet ported
    let current_active: u32 = 0;
    let current_cps_rate: u32 = 0;
...
async fn put_capacity(
    ...
    // Phase 5 Plan 05-04: live capacity gate propagation deferred —
    // trunk_capacity_state not yet ported to sip_stable.
    let current_active: u32 = 0; // live tracking deferred — trunk_capacity_state not yet ported
    let current_cps_rate: u32 = 0;
